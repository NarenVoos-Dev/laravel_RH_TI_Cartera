        ...
        <table id="rolesTable" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Editar"
                            onclick="window.openEditModal({{ $role->id }}, '{{ $role->name }}', '{{ $role->description }}')">
                            <i class="bx bx-edit-alt text-warning"></i>
                        </button>
                        <button class="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Eliminar" onclick="deleteRole({{ $role->id }})">
                            <i class="bx bx-trash-alt text-danger"></i>
                        </button>
                        @can('asignar permisos')
                        <a href="{{ route('roles.permissions', $role->id) }}" class="btn btn-sm btn-light"
                         data-bs-toggle="tooltip" data-bs-placement="top" title="asignar permisos">
